...
export const getAnimePopular = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_keywords=210024&sort_by=popularity.desc&page=4`);
...
export const getAnimationPopular = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_genres=16&with_origin_country=US&sort_by=popularity.desc&page=4`);
        const data = [...data1.results, ...data2.results,...data3.results,...data4.results];
        res.json({success:true,content:data});
    }
    catch(error) {
...
export const getKdramaPopular = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_origin_country=KR&with_original_language=ko&with_genres=18&sort_by=popularity.desc&page=4`);
        const data = [...data1.results, ...data2.results,...data3.results,...data4.results];
        res.json({success:true,content:data});
    }
    catch(error) {
...
export const getAnimeTopRated = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_keywords=210024&sort_by=vote_average.desc&page=4&vote_count.gte=200`);
        const data = [...data1.results, ...data2.results,...data3.results,...data4.results];
        res.json({success:true,content:data});
    }
    catch(error) {
...
export const getAnimationTopRated = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_genres=16&with_origin_country=US&sort_by=vote_average.desc&page=4&vote_count.gte=200`);
        const data = [...data1.results, ...data2.results,...data3.results,...data4.results];
        res.json({success:true,content:data});
    }
    catch(error) {
...
export const getKdramaTopRated = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_origin_country=KR&with_original_language=ko&with_genres=18&vote_count.gte=100&sort_by=vote_average.desc&page=4`);
        const data = [...data1.results, ...data2.results,...data3.results,...data4.results];
        res.json({success:true,content:data});
    }
    catch(error) {
...
export const getAnimeOnAir = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_keywords=210024&first_air_date.lte=${TODAY}&sort_by=first_air_date.desc&page=4`);
        const data = [...data1.results,...data2.results,data3.results,...data4.results]
        res.json({ success: true, content: data });
    } catch (error) {
...
export const getAnimationOnAir = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_genres=16&with_origin_country=US&first_air_date.lte=${TODAY}&sort_by=first_air_date.desc&page=4`);
        const data = [...data1.results,...data2.results,data3.results,...data4.results]
        res.json({ success: true, content: data });
    } catch (error) {
        console.log("Error in getting anime on air: " + error.message);
...
export const getKdramaOnAir = async (req,res) => {
    try {
        ...
        const data4 = await fetchFromTMDB(`https://api.themoviedb.org/3/discover/tv?with_origin_country=KR&with_original_language=ko&with_genres=18&first_air_date.lte=${TODAY}&sort_by=first_air_date.desc&page=4`);
        const data = [...data1.results,...data2.results,data3.results,...data4.results]
        res.json({ success: true, content: data });
    } catch (error) {
        console.log("Error in getting anime on air: " + error.message);
...
export const getRandomTv = async(req,res) => {
    try {
        // Step 1: random page (TMDB max 200 pages)
